(function () {
  ...
  function wideRow() { return get(WIDE_LAYOUT_KEY, 'row') !== 'grid'; }
  ...
  function wideSide(dir) {
    ...
    if (rowsFocused()) {
      ...
      if (dir === 'left') return wideToHero();
      return true;
    }
    if (heroFocused() && dir === 'right') return wideToRows();
    return false;
  }
  ...
  function wideSettings() {
    ...
    Lampa.SettingsApi.addParam({
      ...
      param: {
        ...
        type: 'select',
        values: { row: label('nova_wide_look_row'), grid: label('nova_wide_look_grid') },
        default: 'row'
      },
      field: {
