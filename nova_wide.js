    ...
    if (openingSource) {
      try {
        ...
        if (rowsHeight > 0) {
          ...
          ui.rows.css({ height: Math.ceil(rowsHeight) + 'px', minHeight: Math.ceil(rowsHeight) + 'px' });
        }
      } catch (e) {}
    }
