(function() {
    ...
    var AB_EMAIL = decodeHidden('bmF6YXJvdjZAZ21haWwuY29t');
    var AB_HOST = decodeHidden('aHR0cHM6Ly9hYjIwMjQucnU=');
    var AB_HOST_SLASH = AB_HOST + '/';
    var OKEANTV_HOST_SLASH = decodeHidden('aHR0cDovLzE0OC4xMzUuMjA3LjE3NDoxMjM1OS8=');
    var HDPOISK_HOST_SLASH = decodeHidden('aHR0cHM6Ly9oZHBvaXNrLnJ1Lw==');
    ...
    function getHost() {
        ...
        if (connection_source === 'hdpoisk') return HDPOISK_HOST_SLASH;
        ...
        window.rch_nws[hostkey].typeInvoke(AB_HOST, function() {
            ...
            client.on("RchClient", function(rchId, url, data, headers, returnHeaders) {
                ...
                function sendResult(uri, html) {
                    $.ajax({
                        url: AB_HOST_SLASH + 'rch/' + uri + '?id=' + rchId,
                        type: 'POST',
                        data: html,
                        async: true,
                        cache: false,
    ...
    /* Стартовый вызов typeInvoke отключён */
    /* window.rch_nws[hostkey].typeInvoke(AB_HOST, function() {}); */
    ...
    function rchRun(json, call) {
        if (typeof NativeWsClient == 'undefined') {
            Lampa.Utils.putScript([AB_HOST_SLASH + 'js/nws-client-es5.js?v18112025'], function() {}, false, function() {
                rchInvoke(json, call);
            }, true);
        } else {
            rchInvoke(json, call);
    ...
    function component(object) {
            ...
            filter.onSelect = function(type, a, b) {
                if (type == 'filter') {
                    ...
                    if (a.stype == 'connection') {
                        ...
                        else if (b.index === 2) connection_source = 'hdpoisk';
        ...
        this.filter = function(filter_items, choice) {
            ...
            var current_sub = '';
            if (connection_source === 'ab2024') current_sub = AB_HOST;
            else if (connection_source === 'okeantv') current_sub = OKEANTV_HOST_SLASH.replace(/\/$/, '');
            else current_sub = HDPOISK_HOST_SLASH.replace(/\/$/, '');
            ...
            select.push({
                ...
                items: [
                    ...
                    { title: 'HDPoisk', selected: connection_source === 'hdpoisk', index: 2 }
                ],
                stype: 'connection'
            });
        ...
        var source = {
            ...
            onSelect: function(params, close) {
                ...
                Lampa.Activity.push({
                    ...
                    title: 'Online - ' + params.element.title,
                    component: 'lampac',
    ...
    function startPlugin() {
        ...
        if (!window.plugin_lampac_ready && !window.plugin_iptv_ready2) {
